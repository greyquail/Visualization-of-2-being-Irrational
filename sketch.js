...
// NO trails: only the current two lines and moving point. [web:111][web:118]

let theta = 0;
let speed = 0.01;

let r1, r2;
const RATIO = Math.SQRT2;   // change to Math.PI for the Pi version
...
function draw() {
  ...
  // draw the two arms (lines only, no circles, no trails)
  stroke(200);
  strokeWeight(1 / zoom);
  noFill();
  line(0, 0, x1, y1);
