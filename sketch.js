// Two rotating arms for z(theta) = e^(i theta) + e^(i √2 theta)
// Endpoint draws a line trail; arms show current position. [web:111][web:118]

let theta = 0;
let speed = 0.01;

let r1, r2;
const RATIO = Math.SQRT2;   // change to Math.PI for Pi version
...
function draw() {
  ...
  // draw trail of endpoint as a continuous line
  stroke(200);
  strokeWeight(1 / zoom);
  noFill();
  beginShape();
